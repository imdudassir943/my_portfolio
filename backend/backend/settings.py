...
SIMPLE_JWT = {
    ...
    'BLACKLIST_AFTER_ROTATION': True, # Required for proper logout
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # This line tells Django how to read the "Bearer <token>" header
        'rest_framework_simplejwt.authentication.JWTAuthentication', 
    ),
    'DEFAULT_PERMISSION_CLASSES': (
        # This ensures only logged-in users can access API endpoints by default
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'imudassirpk123@gmail.com'  
EMAIL_HOST_PASSWORD = 'Express@123000'
